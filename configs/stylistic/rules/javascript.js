...
module.exports = (
	...
	'@stylistic/js/arrow-parens': [formatLogLevel,
	                               arrowParens ? 'always' : 'as-needed'],

	// Enforce consistent spacing before and after the arrow in arrow functions
	'arrow-spacing': 0,
	'@stylistic/arrow-spacing': 0,
	'@stylistic/js/arrow-spacing': [formatLogLevel,
	                                arrowParens
	...
	'@stylistic/js/function-call-argument-newline': formatLogLevel,
	...
	'@stylistic/js/function-paren-newline': [formatLogLevel, short ? 'consistent' : 'multiline'],
	...
	'indent': 0,
	'@stylistic/indent': 0,
	'@stylistic/js/indent': [formatLogLevel,
	                         indent,
	...
	'@stylistic/js/key-spacing': [formatLogLevel,
	                              short
	...
	'@stylistic/js/no-extra-parens': short
	                                 ? formatLogLevel
	                                 : [formatLogLevel,
	                                    'all',
	...
	'@stylistic/js/no-mixed-spaces-and-tabs': indent === 'tab'
	...
	'@stylistic/js/no-multiple-empty-lines': [formatLogLevel, {max   : short ? 1 : 2,
	                                                           maxBOF: 0,
	                                                           maxEOF: short ? 0 : 1}],
	...
	'no-tabs': 0,
	'@stylistic/no-tabs': 0,
	'@stylistic/js/no-tabs': indent === 'tab'
	...
	'@stylistic/js/object-curly-newline': [formatLogLevel, {multiline: true}],
	...
	'quotes': 0,
	'@stylistic/quotes': 0,
	'@stylistic/js/quotes': [formatLogLevel,
	                         quotes,
	                         {avoidEscape          : true,
	...
	'@stylistic/js/space-before-function-paren': [formatLogLevel,
