...
export type MaxLengthArray<T, N extends number> =
	...
	: N extends 4 ? MaxLengthArray<T, 3> | [T, T, T, T]
	: N extends 5 ? MaxLengthArray<T, 4> | [T, T, T, T, T]
	: N extends 6 ? MaxLengthArray<T, 5> | ConstArray<T, 6>
	: N extends 7 ? MaxLengthArray<T, 6> | ConstArray<T, 7>
	: N extends 8 ? MaxLengthArray<T, 7> | ConstArray<T, 8>
	: N extends 9 ? MaxLengthArray<T, 8> | ConstArray<T, 9>
	: never;
